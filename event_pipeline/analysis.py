...
CATEGORY_KEYWORDS = {
    ...
    "Concerti e live": ("concerto", "live music", "tributo", "tribute band", "jam session", "live set"),
    "Famiglia": ("bambini", "famiglia", "laboratorio", "kids", "animazione"),
    "Sagre e feste": ("sagra", "festa", "festa patronale", "polenta", "street food"),
    "Enogastronomia": ("degustazione", "vino", "enoteca", "cantina", "birra", "street food", "food truck", "cena degustazione"),
    "Bar e locali": ("bar", "pub", "locale", "aperitivo", "cocktail", "happy hour", "serata"),
    "Nightlife e clubbing": ("discoteca", "dj set", "clubbing", "party", "after party", "nightlife"),
    "Mercatini": ("mercatino", "mercatini", "bancarelle", "artigianato", "antiquariato"),
    "Fiere e mercati": ("fiera", "expo", "salone", "mercato", "mostra mercato"),
    ...
    "Cerimonie e parate": ("parata", "cerimonia", "commemorazione", "celebrazione", "corteo"),
    "Eventi di comunità": ("assemblea pubblica", "incontro pubblico", "manifestazione ufficiale", "evento civico", "festa della comunita"),
    "Intrattenimento indoor": ("bowling", "karaoke", "escape room", "quiz night", "giochi da tavolo", "arcade"),
